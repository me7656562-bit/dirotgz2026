...
/** שוכר מסמן מעוניין */
export async function markInterestAction(listingId: string): Promise<ActionResult> {
  ...
  return { ok: true, message: "✅ סומן! המשכיר יצור איתך קשר בקרוב." };
}
...
/** מחזיר כמה מתעניינים יש + האם המשתמש הנוכחי סימן */
